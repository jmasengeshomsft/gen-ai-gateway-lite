...
Before running the lab, you need to configure your local environment:
...
2. Edit `terraform.tfvars` and update the following required values:
   ...
   - `app_suffix`: A unique suffix for your resources
   - Other values as needed for your environment

3. The `terraform.tfvars` file is gitignored to protect your sensitive configuration data.
